  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: Text('Subscriptions', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700)),
        actions: <Widget>
        [
          Container
          (
                ...
                (
                  ...
                  (
                    ...
                    [
                      ...
                      Text('173 sms unit remains', style: TextStyle(color: Colors.white))
                    ],
                  ),
                ),
              ),
                          ...
                          (
                            ...
                            [
                              ...
                              (
                                ...
                                children: <Widget>
                                [
                                  Text('Individual Plan', style: TextStyle(color: Colors.blueAccent)),
                                  Row
                                  (
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    crossAxisAlignment: CrossAxisAlignment.center,
                                    children: <Widget>
                                    [
                                      Text('4.7', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                              ...
                              (
                                ...
                                [
                                  ...
                                  Text('times for a personal use', style: TextStyle()),
                                  Padding
                                  (
                                    padding: EdgeInsets.symmetric(horizontal: 4.0),
                                    child: Material
                                    (
                                      ...
                                      (
                                        ...
                                        child: Text('N 1200', style: TextStyle(color: Colors.white)),
                                      ),
                                    ),
                                  ),
                                ],
