  ...
  Widget build(BuildContext context)
  {
    ...
    (
      ...
      (
        ...
        title: Text('Smart Messenger', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 30.0)),
        actions: <Widget>
        [
          Container
          (
            ...
            (
              ...
              children: <Widget>
              [
                Text('toykam', style: TextStyle(color: Colors.blue, fontWeight: FontWeight.w700, fontSize: 14.0)),
                ...
                (
                  ...
                  [
                    ...
                    (
                      ...
                      children: <Widget>
                      [
                        Text('Total Sent Message', style: TextStyle(color: Colors.blueAccent)),
              ...
              Padding(
                ...
                (
                  ...
                  [
                    ...
                    Text('Groups', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
              ...
              (
                ...
                (
                  ...
                  [
                    ...
                    Padding(padding: EdgeInsets.only(bottom: 16.0)),
                    Text('Members', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 24.0)),
                ...
                (
                  ...
                  [
                    ...
                    (
                      ...
                      children: <Widget>
                      [
                        Text('Notifications', style: TextStyle(color: Colors.redAccent)),
                        ...
                        (
                          ...
                          [
                            ...
                            (
                              ...
                              children: <Widget>
                              [
                                Text('SMS Statistics', style: TextStyle(color: Colors.green)),
                ...
                (
                  ...
                  [
                    ...
                    (
                      ...
                      children: <Widget>
                      [
                        Text('Subscription', style: TextStyle(color: Colors.redAccent)),
                        Text('173 SMS', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                      ],
                    ),
                    Material
                    (
                      ...
                      (
                        ...
                        (
                          padding: EdgeInsets.all(16.0),
                          child: Icon(Icons.subscriptions, color: Colors.white, size: 30.0),
                        )
                      )
                    )
                  ]
