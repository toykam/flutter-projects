            ...
            Expanded(
              child: Stack(
                children: [
                        ...
                        Container(
                          child: InkWell(
                            onTap: (_loginNotifier.loading == false) ? 
                              () => _loginNotifier.recover_password(context: context, email: _emailTextController.text, password: _passwordTextController.text) : 
                  ...
                  (_loginNotifier.loading || _loginNotifier.loggingIn) ? Container(
